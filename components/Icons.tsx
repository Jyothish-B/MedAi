...
export const MedkitIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M5 19L7.5 16.5" />
    <path d="M7.5 7.5L5 5" />
    <path d="M19 19L16.5 16.5" />
    <rect width="10" height="4" x="7" y="10" rx="1" />
    <path d="M9 10V8" />
    <path d="M15 10V8" />
  </svg>
);
...
export const TranslateIcon: React.FC<IconProps> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="m10.5 21 5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 0 1 6-.371m0 0c1.732 0 3.464.095 5.196.26m-5.196-.26L9 2m0 0L7.5 4.621M9 2l1.5 2.621m0 0L15 2m0 0L16.5 4.621M15 2l1.5 2.621M9 2v18m6-18v18" />
  </svg>
);
...
export const MicrophoneSlashIcon: React.FC<IconProps> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 9.75a6 6 0 0 1-6.003 6c-1.598 0-3.073-.62-4.162-1.628m0 0L3.75 9.375M7.585 16.122A6 6 0 0 1 6 12.75v-1.5m6 7.5v3.75m-3.75 0h7.5M15.75 4.5a3 3 0 1 1-6 0v8.25a3 3 0 1 0 6 0V4.5Z" />
...
export const SpeakerXMarkIcon: React.FC<IconProps> = (props) => (
  <svg {...props} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 9.75 19.5 12m0 0 2.25 2.25M19.5 12l2.25-2.25M19.5 12l-2.25 2.25m-10.5-6 4.72-4.72a.75.75 0 0 1 1.28.53v15.88a.75.75 0 0 1-1.28.53l-4.72-4.72H4.5c-.69 0-1.25-.56-1.25-1.25v-6.5c0-.69.56-1.25 1.25-1.25h2.25Z" />
  </svg>
);
